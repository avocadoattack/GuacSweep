...
[![macOS](https://img.shields.io/badge/macOS-585858?logo=apple&logoColor=white)]()
<br/>
...
> Note: If you have `figlet` and `lolcat` installed, GuacSweep's banner will render as a colorful ASCII logo. Neither is required, and GuacSweep runs identically either way, and falls back to a simple plain-text banner if they're not present. See what the fallback looks like [here](docs/fallback-banner.png).
